...
ecg._dwt()
ecg._delineation()
ecg._add_delineation_data_to_dict(result_data_dict, result_columns_names, id_file)
ecg._add_morphology_data_to_dict(result_data_dict, result_columns_names, id_file)
# Adaptive filtering
ecg._adaptive_filtration()
ecg._add_filter_data_to_dict(result_data_dict, result_columns_names, id_file)
# Characteristics
ecg._characteristics()
ecg._add_characteristics_data_to_dict(result_data_dict, result_columns_names, id_file)
# Plot data
ecg._init_plot_data()
