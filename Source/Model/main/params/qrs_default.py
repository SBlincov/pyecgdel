class QRSDefaultParams:
    ...
    DELTA_QRS_ON_SMALL_SHIFT = 0.25
    DELTA_QRS_ON_LARGE_SHIFT = 0.75
    DELTA_QRS_PEAK_SMALL_SHIFT = 0.25
    DELTA_QRS_PEAK_LARGE_SHIFT = 0.75
    DELTA_QRS_OFF_SMALL_SHIFT = 0.25
    DELTA_QRS_OFF_LARGE_SHIFT = 0.75
