class QRSDefaultParams:
    ...
    DELTA_ON_SMALL_SHIFT_LEFT = 0.25
    DELTA_ON_LARGE_SHIFT_LEFT = 0.75
    DELTA_ON_SMALL_SHIFT_RIGHT = 0.25
    DELTA_ON_LARGE_SHIFT_RIGHT = 0.75
    DELTA_PEAK_SHIFT = 0.55
    DELTA_OFF_SMALL_SHIFT_LEFT = 0.25
    DELTA_OFF_LARGE_SHIFT_LEFT = 0.75
    DELTA_OFF_SMALL_SHIFT_RIGHT = 0.25
    DELTA_OFF_LARGE_SHIFT_RIGHT = 0.75
