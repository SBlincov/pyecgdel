...
from Source.Model.main.delineation.t.peak import get_t_flexure_zc_id
...
class PeakZCsIds:
    ...
    def check_flexure_t(self, ecg_lead, qrs_id, zcs, delineation):

        zc_flexure_id = get_t_flexure_zc_id(ecg_lead, qrs_id, zcs, self.center_zc_id)
